...
vi.mock('$lib/clients/pihole_client', () => ({
	getDomainsFromReference: vi.fn(),
	updateDomainForInstance: vi.fn()
}));
...
describe('POST /api/updateDomainsFromReference', () => {
	beforeEach(() => {
		vi.clearAllMocks();
	});

	it('delegates to syncItemsFromReference with the domains getter and updater', async () => {
